...
![Transformation Matrix Notation](./docs/transformation_matrix_notation.png)

![Camera Aim Equation](./docs/project2_camera_aim_equation.png)
...
As mentioned above, after you have sourced `setup_project2.sh` you can click the 'Connect' button. You will see an interactive visualization of the transforms in the assignment (if you're curious, this was created using [ROS Markers](http://wiki.ros.org/rviz/DisplayTypes/Marker)).

## FAQ

See [Project 2 FAQ](./FAQ.md) for more information on creating and running Project 2.
