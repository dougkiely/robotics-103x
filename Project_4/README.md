...
![Cartesian Control of Robot Manipulators](./docs/Cartesian_Control_of_Robot_Manipulators_-_Ch6.pdf)

![Cartesian Control](./docs/103X_P4_1.png)
...
See [Project 4 FAQ](./FAQ.md) for more information on creating and running the Project 4.
