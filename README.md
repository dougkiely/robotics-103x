...
[Project 1](./Project_1)
Basic ROS functions to broadcast messages usin the ROS Publish/Subscribe features.

[Project 2](./Project_2)
ROS Transformations of a robot with a camera mounted and an object in the environment.

[Project 3](./Project_3)
Forward kinematics for a robot arm defined in a URDF file and running in a ROS environment.

[Project 4](./Project_4)
Cartesian controller for a 7-joint robot arm to interactively control and move the end-effector in Cartesian space, by dragging around an interactive marker.

The primary goal of null-space control is to change the value of the first joint (thus turning the "elbow" of the robot) without affecting the pose of the end-effector.
